...
history_photo=PhotoImage(file="../img/hstictp.png", width=50, height=50)
...
fav_photo=PhotoImage(file="../imgfavictp.png", width=50, height=50)
fav_button.config(image=fav_photo, width=46, height=46)
fav_button.place(x=850, y=250)

aboutus_button = Button(root, bd=0)
aboutus_photo = PhotoImage(file="../img/aboutustp.png", width=50, height=50)
...
reset_photo = PhotoImage(file="../img/resettp.png", height=50, width=50)
